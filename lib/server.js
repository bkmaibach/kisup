        ...
        chosenHandler(data, (statusCode, payload, contentType) => {
            ...
            switch(contentType){
                ...
                case 'plain':
                    ...
                    payloadString = typeof(payload) == 'string' ? payload : '';
                    //How the instructor gets around the problem of the static asset handler calling back with buffer objects is unknown
                    //But I choose to do this... hopefully a good idea
                    payloadString = typeof(payload) == 'object' ? payload.toString('utf-8') : '';
                    break;
